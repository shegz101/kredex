...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex w-[248px] shrink-0 flex-col rounded-3xl bg-white border border-zinc-200 p-5 shadow-sm dark:bg-zinc-900 dark:border-zinc-800">
      {/* Logo */}
      <NavLink to="/" className="flex items-center gap-2 px-2 py-3 group">
      ...
      <div className="mt-auto flex flex-col gap-2">
        ...
        <NavLink
          ...
          className="flex items-center gap-3 rounded-xl px-2 py-2.5 transition-colors hover:bg-zinc-100 dark:hover:bg-zinc-800"
        >
          ...
          <span className="min-w-0">
            ...
            <span className="block text-xs text-zinc-400 dark:text-zinc-500">{shop?.location || shop?.type || ''}</span>
          </span>
        </NavLink>
      </div>
    </aside>
